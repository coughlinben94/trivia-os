export const THEMES = [
  ...
  },
  {
    ...
    colors: { bg: '#2a1238', bgDeep: '#180a28', accent: '#e06a28', highlight: '#ffb84d', text: '#ffeeda', textMuted: '#a06858', shinyBg: '#20102c', shinyAccent: '#ff5a8c' },
    fonts: { display: 'Boogaloo', body: 'DM Sans', ui: 'DM Sans' },
    particles: { color: '#ffb84d', count: 40, behavior: 'float' },
