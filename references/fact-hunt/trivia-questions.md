> Snapshot of the `trivia-questions` skill (repo root `trivia-questions/SKILL.md`, mirrored at `~/.claude/skills/trivia-questions/SKILL.md`), re-copied 2026-09-02 after the Taste Profile v2 rewrite. The skill is source of truth — if this drifts, re-copy. Referenced by `.claude/commands/fact-hunt.md`; read alongside `taste-profile.md` and `question-anatomy.md`.
